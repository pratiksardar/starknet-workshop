...
var Q = (I, M, e) => M in I ? m(I, M, { enumerable: !0, configurable: !0, writable: !0, value: e }) : I[M] = e;
var w = (I, M, e) => (Q(I, typeof M != "symbol" ? M + "" : M, e), e), y = (I, M, e) => {
  if (!M.has(I))
    throw TypeError("Cannot " + e);
};
var c = (I, M, e) => (y(I, M, "read from private field"), e ? e.call(I) : M.get(I)), z = (I, M, e) => {
  if (M.has(I))
...
class f {
  constructor(M) {
    ...
    z(this, u, void 0);
    w(this, "value");
    l(this, u, M), n(this, a, s).call(this);
  }
  set(M) {
    return !c(this, A) && !n(this, a, s).call(this) ? !1 : (this.delete(), this.value = M, M && (l(this, i, `${c(this, u)}-${U()}`), localStorage.setItem(c(this, i), M)), !0);
  }
  get() {
    return n(this, o, k).call(this), this.value;
  }
  delete() {
    return !c(this, A) && !n(this, a, s).call(this) ? !1 : (this.value = null, c(this, i) && localStorage.removeItem(c(this, i)), !0);
  }
}
A = new WeakMap(), i = new WeakMap(), u = new WeakMap(), o = new WeakSet(), k = function() {
...
function v(I = {}) {
  ...
  return {
    ...
    getLastConnectedWallet: async () => {
      ...
      return T || (D.delete(), null);
    },
    enable: async (g, j) => {
      await g.request({
        type: "wallet_requestAccounts",
        params: {
          silent_mode: j == null ? void 0 : j.silent_mode
        }
      });
